...
resnet_model.compile(optimizer=tf.keras.optimizers.Adam(lr=0.005),loss='mean_squared_error', metrics=["MeanAbsoluteError", "MeanAbsolutePercentageError", "MeanSquaredError", "RootMeanSquaredError", "MeanSquaredLogarithmicError", "CosineSimilarity"])#standard regression metrics 

#print('#################', train_gen[1])# {issue here.. have a look!!!}

callbacks = [
    keras.callbacks.CSVLogger('C:\\Users\\smart\\Documents\\Part Time - EHU\\Workspace\\NuCLS\\Ep100\\LR_0_005\\Log_Files\\Res50\\log0.csv', separator = ',', append = True),
    keras.callbacks.ModelCheckpoint("C:\\Users\\smart\\Documents\\Part Time - EHU\\Workspace\\NuCLS\\Ep100\\LR_0_005\\Models\\Res50\\model0.{epoch:02d}-{val_loss:.2f}.h5", save_best_only=True)
]
