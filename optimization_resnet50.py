...
def build_model(hp):
    ...
    resnet_model.compile(optimizer=tf.keras.optimizers.Adam(hp.Choice('learning_rate',
...
tuner = RandomSearch(
    ...
    directory = 'my_dir',
    project_name = 'ResNet50_Hyperparameter_Optimization')
...
history = tuner.search(train_gen, validation_data=val_gen, epochs=25)
