...
callbacks = [
    keras.callbacks.CSVLogger('C:\\Users\\smart\\Documents\\Part Time - EHU\\Workspace\\NuCLS\\Log_Files\\Res101_Conv5\\log0.csv', separator = ',', append = True),
    keras.callbacks.ModelCheckpoint("C:\\Users\\smart\\Documents\\Part Time - EHU\\Workspace\\NuCLS\\Models\\Res101_Conv5\\model0.{epoch:02d}-{val_loss:.2f}.h5", save_best_only=True)
]
