...
def build_model():
    ...
    pretrained_model= tf.keras.applications.ResNet101(include_top=False,
                   ...
                   weights='imagenet')
    for i, layer in enumerate(pretrained_model.layers[0:81]):
        print(i, layer.name)
...
callbacks = [
    keras.callbacks.CSVLogger('C:\\Users\\smart\\Documents\\Part Time - EHU\\Workspace\\NuCLS\\Log_Files\\Res101_Conv4_5\\log0.csv', separator = ',', append = True),
    keras.callbacks.ModelCheckpoint("C:\\Users\\smart\\Documents\\Part Time - EHU\\Workspace\\NuCLS\\Models\\Res101_Conv4_5\\model0.{epoch:02d}-{val_loss:.2f}.h5", save_best_only=True)
]
